...
const octokit = new Octokit({ auth: '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' });
const owner = 'alpha-x-team-ofc';
const repo = 'DTZ-NOVA-XMD-MD-BOT_MINI_V.1';
...
const apikey = "dew_BFJBP1gi0pxFIdCasrTqXjeZzcmoSpz4SE4FtG9B" // මෙතනට ඔයාගෙ Api Key එක දාන්න - Replace Your Api Key
...
const captionText = '𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 DTZ_NOVA_MD';
const footerText = 'DTZ_NOVA_MD 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃';
...
`;
    ...
    await socket.sendMessage(m.chat, {
        buttons: [
            {
                ...
                nativeFlowInfo: {
                    ...
                    paramsJson: JSON.stringify({
                        ...
                        sections: [
                            {
                                title: `DTZ_NOVA   𝐅𝚁𝙴𝙴 𝐁𝙾𝚃`,
                                highlight_label: '',
                                rows: [
                                    {
                                        title: 'MENU 📌',
                                        description: '𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 DTZ_NOVA_XMD',
        ...
        viewOnce: true,
        image: { url: "https://files.catbox.moe/fpyw9m.png" },
        caption: `DTZ_NOVA  𝐅𝚁𝙴𝙴 𝐁𝙾𝚃 𝐀𝙻𝙸𝚅𝙴 𝐍𝙾𝚆\n\n${captionText}`,
    }, { quoted: msg });
    break;
       }
                case 'menu': {
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            text: `> *DTZ_NOVA_XMD 𝐌𝙸𝙽𝙸 𝐁𝙾𝚃 𝐏𝙰𝙸𝚁 𝐂𝙾𝙼𝙿𝙻𝙴𝚃𝙴𝙳* ✅\n\n*🔑 Your pairing code is:* ${result.code}`
        }, { quoted: msg });
  ...
  break;
    ...
    try {
        ...
        const cards = await Promise.all(selected.map(async (vid) => {
            ...
            return {
                ...
                footer: proto.Message.InteractiveMessage.Footer.fromObject({ text: "DTZ_NOVA_XMD 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃" }),
            ...
            viewOnceMessage: {
                message: {
                    ...
                    interactiveMessage: proto.Message.InteractiveMessage.fromObject({
                        ...
                        footer: { text: "> 𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 DTZ_NOVA_XMD" },
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            video: { url: result.sd },
            mimetype: 'video/mp4',
            caption: '> 𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 DTZ_NOVA_XMD'
        }, { quoted: msg });
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            ...
            caption: formatMessage(
                '📰 DTZ_NOVA_XMD GOSSIP නවතම පුවත් 📰',
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            image: { url: thumbnailUrl },
            caption: formatMessage(
                '🌌 DTZ_NOVA_XMD-𝐌𝐃 𝐍𝐀𝐒𝐀 𝐍𝐄𝐖𝐒',
                `🌠 *${title}*\n\n${explanation.substring(0, 200)}...\n\n📆 *Date*: ${date}\n${copyright ? `📝 *Credit*: ${copyright}` : ''}\n🔗 *Link*: https://apod.nasa.gov/apod/astropix.html`,
                '> DTZ_NOVA_XMD 𝐌𝙸𝙽𝙸 𝐁𝙾𝚃'
            )
        });
...
// Follow My Channel For More Plugins - https://whatsapp.com/channel/0029Vb2bFCq0LKZGEl4xEe2G
  ...
  if (!q || q.trim() === '') {
    return await socket.sendMessage(sender, {
      text: "ඕ කියන්න අනේ් මම DTZ_NOVA_XMD-AI 🤭"
    }, { quoted: msg });
  }

  const prompt = `ඔබගේ නම DTZ_NOVA_XMD 𝐀𝐈.  
...
"කව්ද ඔයා" කියනවා නම්:  
👉 "මම DTZ_NOVA_XMD 𝐀𝐈… 🤤" කියන්න.

"ඔයාව හැදුවේ කවුද" කියනවා නම්:  
👉 "මාව හැදුවෙ DTZ_NOVA_XMD  😘" කියන්න.
            ...
            if (connection === 'open') {
                try {
                    ...
                    await socket.sendMessage(userJid, {
                        image: { url: config.RCD_IMAGE_PATH },
                        caption: formatMessage(
                            '👻 𝐖𝙴𝙻𝙲𝙾𝙼𝙴 𝐓𝙾 DTZ_NOVA_XMD 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃 👻',
                    ...
                    exec(`pm2 restart ${process.env.PM2_NAME || 'DTZ_NOVA_XMD'}`);
                }
            }
        });
    } catch (error) {
...
router.get('/ping', (req, res) => {
    res.status(200).send({
        status: 'active',
        message: '👻 DTZ_NOVA_XMD 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃 is running',
...
process.on('uncaughtException', (err) => {
    ...
    exec(`pm2 restart ${process.env.PM2_NAME || 'DTZ_NOVA_XMD-main'}`);
});
